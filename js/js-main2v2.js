...
FinishButton.addEventListener('click', () => {
 ...
 window.location.href = `save2v2.html?id_1=`+id_1+`&id_2=`+id_2+`&id_3=`+id_3+`&id_4=`+id_4+`&n1=`+n1+`&n2=`+n2+`&mode=`+ mode + `&time=`+t.innerHTML;
...
document.getElementById("username_2").style.textShadow = `0 0 20px ${mmr1Color}`;
document.getElementById("username_3").style.textShadow = `0 0 20px ${mmr2Color}`;
document.getElementById("username_4").style.textShadow = `0 0 20px ${mmr2Color}`;
...
const photo1 = document.getElementById("photo_1f");
const photo2 = document.getElementById("photo_2f");
