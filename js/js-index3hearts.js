  ...
  let usernameToShow = username;
    ...
    blockmain_users1.innerHTML = `
        <div class="container">
            ...
            <div class="photo_1 photo"><img src="${photo_url ? photo_url : 'avatar-profil.jfif'}" alt="Фото користувача"></div>
  ...
  let usernameToShow = username;
    ...
    blockmain_users2.innerHTML = `
        <div class="container">
            ...
            <div class="photo_2 photo"><img src="${photo_url ? photo_url : 'avatar-profil.jfif'}" alt="Фото користувача"></div>
  ...
  let usernameToShow = username;
    ...
    blockmain_users3.innerHTML = `
        <div class="container">
            ...
            <div class="photo_3 photo"><img src="${photo_url ? photo_url : 'avatar-profil.jfif'}" alt="Фото користувача"></div>
  ...
  let usernameToShow = username;
    ...
    blockmain_users4.innerHTML = `
        <div class="container">
            ...
            <div class="photo_4 photo"><img src="${photo_url ? photo_url : 'avatar-profil.jfif'}" alt="Фото користувача"></div>
            ...
            if (snapshot.exists()) {
                ...
                const queryString1 = `&id_1=${encodeURIComponent(id)}&username_1=${encodeURIComponent(usernameToShow1)}&photo_url_1=${encodeURIComponent(photo_url ? photo_url : 'avatar-profil.jfif')}`;
                  ...
                  get(player4Ref).then((snapshot) => {
                    ...
                    window.location.href = `main3hearts.html?mode=${encodeURIComponent(selectedMode)}${queryString1}${queryString2}${queryString3}${queryString4}`;
